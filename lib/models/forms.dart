          ...
          RaisedButton(
            onPressed: () {
              ...
              if (_formKey.currentState.validate()) {
                ...
                globalHelper.adminData.dealership = dealership.text;
                globalHelper.adminData.dealershipUUID = dealershipUUID.text;
                globalHelper.adminData.employeeEmail = employeeEmailController.text;
                globalHelper.adminData.employeePhone = employeePhoneNumberController.text;
                globalHelper.adminData.employeeName = employeeNameController.text;
                globalHelper.adminData.employeeUUID = employeeUUIDController.text;
                globalHelper.adminData.moduleUUID = moduleID.text;

                print('Oh no: ${globalHelper.adminData.employeeUUID}');
